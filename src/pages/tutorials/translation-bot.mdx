...
import MohCitrus from "./_images/translation-bot/MohCitrus.webp"
import Demo from "./_images/translation-bot/MohCitrus-Demo.webp"
...
2. Hop onto MohCitrus' chat.
3. Type "!join" in the chat.
4. Set MohCitrus as a moderator in your channel by typing `/mod MohCitrus` in your own chat.

<br />
<Image src={Demo} alt="MohCitrus demo" width="500" loading="lazy" />
