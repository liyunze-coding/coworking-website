...
path: "/src/pages/guide/music-and-audio.mdx"
order: 1
---
...
import AudioSettings from "./_images/music-and-audio/audio_settings.webp";
...
Having awful microphone quality on stream would negatively affect the viewer experience. Here are a few tips on how to improve your microphone quality on OBS using filters!
...
- ### Noise Suppression
  ...
  The Noise suppression filter OBS helps you easily suppress background noise! You have 2 methods to choose from:
...
- ### Compressor
  ...
  Is your microphone at maximum volume, yet your viewers can't hear you very well? A compressor filter is used to even out the volume levels of your microphone input. It works by reducing the dynamic range of the audio signal, making quieter sounds louder and louder sounds quieter.
...
<a href="https://pixelchat.tv/" target="_blank"><Image src={PixelChat} alt="Pixel Chat widget" loading="lazy" /></a>
...
- ### [Rain Ambience 🔗](https://pixabay.com/sound-effects/search/rain/)
  ...
  The steady pitter-patter of rain ambience offers a soothing and concentration-boosting study backdrop.

- ### [Ocean Ambience 🔗](https://pixabay.com/sound-effects/search/ocean%20ambience/)

  Its rhythmic waves provide a calming yet stimulating soundscape that can enhance focus.
...
Suppose you’re streaming on Twitch using OBS. In that case, you can easily avoid getting your VODs muted by separating audio tracks into VOD audio tracks and stream audio tracks. This way, you can listen to music on your stream without worrying about getting muted.
...
<Image src={AudioSettings} alt="Audio settings" loading="lazy" />

You'll need to have two different audio outputs (i.e. two headphones/speakers). For Windows users, go to sound settings --> advance sound options --> app volume device preferences (or if you can't find it, search "sound mixer options" in your start) then you should see this:

There, you can have your different outputs for different programmes. For example, one pair of headphones is used for zoom, and the other for everything else. In your streaming software, ensure the output is selected for the correct pair of headphones in your mixer!
